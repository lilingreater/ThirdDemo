...
public class OptionsPopupWindow extends PopupWindow implements OnClickListener {
    ...
    private TextView tv_kaoqi, tv_lunci;
...
//        tv_kaoqi = (TextView) rootView.findViewById(R.id.tv_kaoqi);
//        tv_lunci = (TextView) rootView.findViewById(R.id.tv_lunci);
    ...
    public void setTitle(String kaoqi, String lunci) {
        if (kaoqi != null && kaoqi.isEmpty()) {
            tv_kaoqi.setText(kaoqi);
        }
        if (lunci != null && lunci.isEmpty()) {
            tv_lunci.setText(lunci);
        }
