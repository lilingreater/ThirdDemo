...
//		setBackgroundResource(R.drawable.wheel_bg);
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        Log.e("TAG", "itemsWidth==" + itemsWidth);
        itemsWidth += ADDITIONAL_ITEMS_SPACE; // make it some more
        Log.e("TAG", "itemsWidth+ADDITIONAL_ITEMS_SPACE==" + itemsWidth);
        ...
        Log.e("TAG", "labelWidth=" + labelWidth);
        ...
        Log.e("TAG", "itemswidth222==" + itemsWidth);
        Log.e("TAG", "labelWidth222==" + labelWidth);
...
//		canvas.scale(1.2f, 1.2f);
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        int width = itemsLayout.getWidth();//textview的宽度
        Log.e("TAG", "width="+width);
        Log.e("TAG", "itemsWidth="+itemsWidth);
        Log.e("TAG", "labelWidth="+labelWidth);
        centerDrawable.setBounds(0, center - offset, itemsWidth, center
                + offset);
