...
public class GugleUtils
{
	...
	public static int getFileType(boolean isFolder, String fileName)
	{
		...
		if (GugleUtils.isEmpty(fileName))
		{
		...
		{
			// 安装文件
			FILE_TYPE.put("APK", R.drawable.apk);
			...
			// 压缩文件
			FILE_TYPE.put("ZIP", R.drawable.zip_icon);
			FILE_TYPE.put("RAR", R.drawable.zip_icon);
			FILE_TYPE.put("TAR", R.drawable.zip_icon);
			FILE_TYPE.put("GZ", R.drawable.zip_icon);
			FILE_TYPE.put("7Z", R.drawable.zip_icon);
			...
			// 图片文件
			FILE_TYPE.put("JPG", R.drawable.image);
			FILE_TYPE.put("PNG", R.drawable.image);
			FILE_TYPE.put("BMP", R.drawable.image);
			FILE_TYPE.put("GIF", R.drawable.image);
			FILE_TYPE.put("JPEG", R.drawable.image);
			...
			FILE_TYPE.put("OTHER", R.drawable.unknown);
		}
