...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fl_test = findViewById(R.id.fl_test);
        ...
        // only all sides except top shadow
        sp = new ShadowProperty()
                .setShadowColor(0x55000000)
                .setShadowDy(dip2px(this, 0.3f))
                .setShadowRadius(dip2px(this, 3))
                .setShadowSide(ShadowProperty.ALL);
        sd = new ShadowViewDrawable(sp, Color.TRANSPARENT, 0, 0);
        ViewCompat.setBackground(ll_course, sd);
        ViewCompat.setLayerType(ll_course, ViewCompat.LAYER_TYPE_SOFTWARE, null);
        // only all sides except top shadow
        sp = new ShadowProperty()
                .setShadowColor(0x99000000)
                .setShadowDy(dip2px(this, 0.5f))
                .setShadowDx(dip2px(this, 0.5f))
                .setShadowRadius(dip2px(this, 2))
                .setShadowSide(ShadowProperty.ALL);
        sd = new ShadowViewDrawable(sp, Color.TRANSPARENT, 0, 0);
        ViewCompat.setBackground(fl_test, sd);
        ViewCompat.setLayerType(fl_test, ViewCompat.LAYER_TYPE_SOFTWARE, null);
    }
